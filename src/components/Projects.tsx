...
const Projects = () => {
  return (
    <div className='text-white bg-[#252A34] p-5 laptop:px-72'>
        ...
        <h2 className='text-center mb-6 text-base'>Personal projects I have worked on</h2>
